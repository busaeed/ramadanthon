                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="role" type="radio" name="role" value="volunteer" required autofocus>Volunteer
                                <input id="role" type="radio" name="role" value="coordinator" required autofocus>Coordinator
